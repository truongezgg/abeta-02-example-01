...
export class Migrations1714644699376 implements MigrationInterface {
  name = 'Migrations1714644699376';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE \`post\` (
                ...
                \`created_at\` datetime(6) NULL COMMENT 'Timestamp of creation',
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE \`post\` CHANGE \`created_at\` \`created_at\` datetime(6) NULL COMMENT 'Timestamp of creation'
        `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE \`post\` CHANGE \`created_at\` \`created_at\` datetime(6) NOT NULL COMMENT 'Timestamp of creation' DEFAULT CURRENT_TIMESTAMP(6)
        `);
    await queryRunner.query(`
